...
PAYLOAD_URL = "https://raw.githubusercontent.com/DrStrangel0ve/3dprintpic/codex-colab-payloads/colab_payloads/g4_stl_first_trellis2_component_close_guard_s40_n5_commita628e17.tar.gz"
ARCHIVE_PATH = pathlib.Path("/content/g4_stl_first_trellis2_component_close_guard_s40_n5_commita628e17.tar.gz")
EXTRACT_ROOT = pathlib.Path("/content/3dprintpic_colab_inputs")
EXPECTED_SHA256 = "cd957a838f36dcf52c70c8e683284433ad2ca4c0f495ac39d6ed3811a0107065"
EXPECTED_SIZE = 650455
LAUNCH_ENV = {"ATTN_BACKEND": "sdpa", "SPARSE_ATTN_BACKEND": "sdpa", "SPARSE_CONV_BACKEND": "flex_gemm", "TRELLIS2_PREFETCH": "1", "TRIPOSG_USE_FLASH_DECODER": "0"}
