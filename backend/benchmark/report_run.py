...
KEY_METRICS = [
    ...
    ("provider_inference_runtime_seconds_median", "Provider Inference Seconds"),
    ("provider_invocation_runtime_seconds_median", "Provider Invocation Seconds"),
    ("direct_mesh_command_runtime_seconds_median", "Direct Mesh Command Seconds"),
    ("repair_runtime_seconds_median", "Mesh Repair Seconds"),
    ("mesh_postprocess_runtime_seconds_median", "Mesh Postprocess Seconds"),
    ("provider_peak_cuda_vram_gib_median", "Provider Peak CUDA VRAM GiB"),
    ("raw_mesh_volume_fill_ratio_median", "Raw Volume Fill Ratio"),
    ("raw_mesh_volume_fill_ratio_reliable_mean", "Raw Volume Fill Reliability"),
    ("raw_mesh_volume_fill_ratio_topology_assessed_mean", "Raw Volume Topology Assessed"),
    (
        "raw_mesh_volume_fill_ratio_self_intersection_assessed_mean",
        "Raw Volume Self-Intersections Assessed",
    ),
    ("raw_mesh_surface_fill_ratio_median", "Raw Surface Fill Proxy"),
    ("raw_mesh_surface_fill_ratio_supported_mean", "Raw Surface Fill Proxy Support"),
    ("stl_volume_fill_ratio_median", "STL Volume Fill Ratio"),
    ("stl_surface_fill_ratio_median", "STL Surface Fill Proxy"),
    ...
    ("repair_fill_ratio_relative_change_median", "Canonical Repair Fill Relative Change"),
    ("repair_fill_ratio_relative_change_abs_median", "Canonical Repair Fill Absolute Relative Change"),
    ("repair_fill_ratio_surface_proxy_used_mean", "Repair Surface Fill Proxy Rate"),
    ("repair_fill_ratio_supported_mean", "Canonical Repair Fill Support"),
