...
def build_triposg_setup_prelude() -> str:
    return (
        ...
        "import importlib\n"
        "missing = []\n"
        "for name in ('torch', 'diffusers', 'transformers', 'trimesh', 'diso', 'triposg.pipelines.pipeline_triposg'):\n"
        "    try:\n"
        "        importlib.import_module(name)\n"
        ...
        "print(target)\n"
        "PY\n"
        "  \"$TRIPOSG_VENV/bin/python\" -m pip install numpy==2.0.2 trimesh==4.12.2 Pillow==10.1.0 huggingface-hub imageio diso==0.1.4\n"
