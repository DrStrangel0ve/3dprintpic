...
def build_colab_run_script(
    *,
    ...
    return (
        ...
        "    return digest\n"
        "\n"
        "def run_stl_ingest_report(output_root: pathlib.Path, ingest_dir: pathlib.Path, json_path: pathlib.Path, md_path: pathlib.Path) -> dict:\n"
        ...
        "        result['reason'] = 'output_root_missing'\n"
        "        return result\n"
        ...
        "stl_ingest_report = run_stl_ingest_report(output_root, stl_ingest_dir, stl_ingest_json, stl_ingest_md)\n"
        "summary = {\n"
