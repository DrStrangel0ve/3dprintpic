...
5. Run the pinned Hunyuan3D-2mv one-row octants G4 smoke, then compare its standard 50-step raw and repaired meshes against promoted TripoSG on the same ten held-out assets.
