...
5. Add Hunyuan3D-2mv as the next learned multiview lane for selected front/right/back/left or video-frame bundles, normalizing its final mesh through the same STL diagnostics.
