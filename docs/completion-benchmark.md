...
The checked one-row debug package for that retry was regenerated from repo commit `343ba9c3a8edb630c572c1bd919ddfe5efcb7023` as `g4_stl_first_hunyuan3d_shape_debug_s40_n1`. It packaged one held-out row, uses `candidate_method=hunyuan3d_shape_masked_repaired_stl_mirror_bbox_direct_mesh`, keeps `current_method=mirror`, and requires `min_paired_n=1`. The local artifact `modelnet10_heldout1_stl_first_hunyuan3d_shape_debug_colab_inputs.tar.gz` is `133,247` bytes with SHA256 `5ab7a168b3a8a30d53f07883452cd04f0c3da42fb52681a79b3214b9acb87188`; the inline launcher SHA256 is `79a2b784ad63e28d5e692ac7e7a29d6d8e4d1c54b3fe81368cee8f845cc95906`, the fetch launcher SHA256 is `b57fabc911dd140a105a6eaa6cf64b97febc5d7ffbcccd0c836675387aeef6a0`, and the fetch notebook SHA256 is `db70084434816c04b6b381aaf5dc9307791701e8bac4f1ea2af4470785fa0c96`.

The immutable debug payload archive is published from payload commit `b65589cda8d2537407d301c45782d77899c5541a` at `https://raw.githubusercontent.com/DrStrangel0ve/3dprintpic/b65589cda8d2537407d301c45782d77899c5541a/colab_payloads/modelnet10_heldout1_stl_first_hunyuan3d_shape_debug_colab_inputs.tar.gz`. The paste-free notebook is published from payload commit `3debd7c695fc637aa746f64af024bfa53b175708` at `https://colab.research.google.com/github/DrStrangel0ve/3dprintpic/blob/3debd7c695fc637aa746f64af024bfa53b175708/colab_payloads/run_colab_hunyuan3d_shape_debug_eval_fetch_notebook.ipynb`; its raw notebook URL validated at `3,459` bytes with SHA256 `db70084434816c04b6b381aaf5dc9307791701e8bac4f1ea2af4470785fa0c96`, and the raw archive validated at `133,247` bytes with SHA256 `5ab7a168b3a8a30d53f07883452cd04f0c3da42fb52681a79b3214b9acb87188`.
