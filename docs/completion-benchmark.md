...
Prepared adaptive G4 artifacts use run name `g4_stl_first_triposg_inferred_adaptive_s40_n10`, the same held-out rows `40-49`, candidate `triposg_biharmonic_prefill_repaired_stl_inferred_bbox_direct_mesh`, current method `mirror`, `min_paired_n=10`, and the existing G4/Blackwell 90 GB guard. The deterministic payload `colab_payloads/modelnet10_heldout10_stl_first_triposg_inferred_adaptive_colab_inputs.tar.gz` is `1,625,982` bytes with SHA256 `09bbec3231ed4c5ab7d5e2b3b6ebe1c3db930aa5efa1950ae4982b483bd1f98e`. Its fetch cell is `3,915` bytes with SHA256 `35865bf4d6f970c2fdd6334576cc881b104d75726461a07bc510286e0e074558`; the fetch notebook is `5,818` bytes with SHA256 `185ffe826a524b5ff503321fe6b4fe0ab5562e424d1f9e8c9a990aa5dc5c736a`. Regenerating the archive with the same command produced the same SHA256. The notebook is `https://colab.research.google.com/github/DrStrangel0ve/3dprintpic/blob/codex/3d-completion-benchmark-g4/colab_payloads/run_colab_triposg_inferred_adaptive_eval_fetch_notebook.ipynb` after these artifacts are pushed.
