...
The checked one-row debug package for that retry was regenerated from repo commit `841e905c47eb68a11344d6b4e51acaeffc2ae159` as `g4_stl_first_hunyuan3d_shape_debug_s40_n1`. It packaged one held-out row, uses `candidate_method=hunyuan3d_shape_masked_repaired_stl_mirror_bbox_direct_mesh`, keeps `current_method=mirror`, and requires `min_paired_n=1`. The local artifact `modelnet10_heldout1_stl_first_hunyuan3d_shape_debug_colab_inputs.tar.gz` is `132,997` bytes with SHA256 `43f4bb2c589cd32e84029645363aca2e7f17d267f8e886bc27e74bde163bdeb6`; the inline launcher SHA256 is `73b8260e9f7b40cc5ef21c61c06045cc1322da2c04cafb5c507dd574abe516f5`, the fetch launcher SHA256 is `db7b68c1be9d20e5f200021d4a81119e82b7a6e9fc81d8068af55f1e576edf2b`, and the fetch notebook SHA256 is `f5a08423fcdd87c591bd47298096e87ebc97f0c01dc2a334f97fb537f930e117`.

The immutable debug payload archive is published from payload commit `2b6e02a457ac3dd7edd3714597607078b2b949c5` at `https://raw.githubusercontent.com/DrStrangel0ve/3dprintpic/2b6e02a457ac3dd7edd3714597607078b2b949c5/colab_payloads/modelnet10_heldout1_stl_first_hunyuan3d_shape_debug_colab_inputs.tar.gz`. The paste-free notebook is published from payload commit `5020ca24c97ccbbf3f615569f70557f5cd717a63` at `https://colab.research.google.com/github/DrStrangel0ve/3dprintpic/blob/5020ca24c97ccbbf3f615569f70557f5cd717a63/colab_payloads/run_colab_hunyuan3d_shape_debug_eval_fetch_notebook.ipynb`; its raw notebook URL validated at `3,459` bytes with SHA256 `f5a08423fcdd87c591bd47298096e87ebc97f0c01dc2a334f97fb537f930e117`, and the raw archive validated at `132,997` bytes with SHA256 `43f4bb2c589cd32e84029645363aca2e7f17d267f8e886bc27e74bde163bdeb6`.
