...
If the Colab UI has trouble accepting the 2 MB inline paste, use the smaller fetch cell `run_colab_hunyuan3d_shape_eval_fetch_cell.py` from the local `outputs` directory or open the paste-free Colab notebook at `https://colab.research.google.com/github/DrStrangel0ve/3dprintpic/blob/0276b6df7a62596be7765dec00c9e90ac6fb6744/colab_payloads/run_colab_hunyuan3d_shape_eval_fetch_notebook.ipynb`. The notebook is published from payload commit `0276b6df7a62596be7765dec00c9e90ac6fb6744`, has raw SHA256 `090786bb63f504742561327088758f2150935837938978663b23cde5bfecae37`, and downloads the immutable tarball from archive commit `2782e975900925f8d01db9da5fc6cf321048cdb7`. The tarball raw download was validated at `1,621,867` bytes with SHA256 `238125c0971a510918b36909fe7a8631fd2f2cabc8387e8a1248a895b8dff81e`; the fetch launcher verifies that exact size/SHA, extracts `run_colab_eval.sh`, and launches the same Hunyuan setup/eval path.
