...
The checked one-row debug package for that retry was regenerated from repo commit `fd525efc2b6cdc60ac1307b01b9d190edaf754d1` as `g4_stl_first_hunyuan3d_shape_debug_s40_n1`. It packaged one held-out row, uses `candidate_method=hunyuan3d_shape_masked_repaired_stl_mirror_bbox_direct_mesh`, keeps `current_method=mirror`, and requires `min_paired_n=1`. The local artifact `modelnet10_heldout1_stl_first_hunyuan3d_shape_debug_colab_inputs.tar.gz` is `133,303` bytes with SHA256 `96e851a823f72f243c19a7219d721b2b49e99d20709e6fca0e05a09e63d4e119`; the inline launcher SHA256 is `44b764faf4f59f883207b1c25b0357d45a252534a4ef9566dcf96648518b5a38`, the fetch launcher SHA256 is `d18d419e00d6f3ef76e611fe2c3060aafe676a50e7821cabe0df64370e046001`, and the fetch notebook SHA256 is `f65260961b293005a179419605b4cae18cae2e75bcb8a9019f20498c621b38d9`.

The immutable debug payload archive is published from payload commit `18564fba0af5c2bd4a056b4791ab80ba2fbf51e0` at `https://raw.githubusercontent.com/DrStrangel0ve/3dprintpic/18564fba0af5c2bd4a056b4791ab80ba2fbf51e0/colab_payloads/modelnet10_heldout1_stl_first_hunyuan3d_shape_debug_colab_inputs.tar.gz`. The paste-free notebook is published from payload commit `7670dbee6b79bb7de1b8175bd0de12d01b33e561` at `https://colab.research.google.com/github/DrStrangel0ve/3dprintpic/blob/7670dbee6b79bb7de1b8175bd0de12d01b33e561/colab_payloads/run_colab_hunyuan3d_shape_debug_eval_fetch_notebook.ipynb`; its raw notebook URL validated at `3,459` bytes with SHA256 `f65260961b293005a179419605b4cae18cae2e75bcb8a9019f20498c621b38d9`, and the raw archive validated at `133,303` bytes with SHA256 `96e851a823f72f243c19a7219d721b2b49e99d20709e6fca0e05a09e63d4e119`.
