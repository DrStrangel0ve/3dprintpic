...
If the Colab UI has trouble accepting the 2 MB inline paste, use the smaller fetch cell `run_colab_hunyuan3d_shape_eval_fetch_cell.py` from the local `outputs` directory or open the paste-free Colab notebook at `https://colab.research.google.com/github/DrStrangel0ve/3dprintpic/blob/aa8d4addbe0421fa49f3c35579f0412b2016951b/colab_payloads/run_colab_hunyuan3d_shape_eval_fetch_notebook.ipynb`. The notebook is published from payload commit `aa8d4addbe0421fa49f3c35579f0412b2016951b`, has raw SHA256 `0f5292d5dd7f28a8804d55c0e1fd32024a068b5a1db60f554ca1391630971ac4`, and downloads the immutable tarball from archive commit `1cd45b9cf3de931fe54506f7e09176ea2e4301ab`. The tarball raw download was validated at `1,621,892` bytes with SHA256 `5032017411c1975525b852c4ea73e290329dc2e211ef898118e0d6ed18bbf539`; the fetch launcher verifies that exact size/SHA, extracts `run_colab_eval.sh`, and launches the same Hunyuan setup/eval path.
